    ...
    t.prototype.initMenu = function () {
        ...
        l("#side-menu").length && ((s = l("#side-menu li .collapse")).on({
            ...
            if (this.href == t) {
                ...
                l(this).parent().parent().parent().parent().addClass("menuitem-active");
                var e = l(this).parent().parent().parent().parent().parent().parent();
                "sidebar-menu" !== e.attr("id") && e.addClass("show"),
                l(this).parent().parent().parent().parent().parent().parent().parent().addClass("menuitem-active");
    ...
    t.prototype.changeMode = function (t) {
        switch (t) {
            case "dark":
                ...
                this._saveConfig({mode: t, sidebar: n.extend({}, this.config.sidebar, {color: "dark"})});
                break;
            default:
                ...
                this._saveConfig({mode: t, sidebar: n.extend({}, this.config.sidebar, {color: "light"})})
        }
    ...
    t.prototype.changeLayoutWidth = function (t) {
        switch (t) {
            ...
            default:
                ...
                n.LeftSidebar.changeSize(e && e.sidebar ? e.sidebar.size : "default"),
                this._saveConfig({width: t})
        }
        this.rightBar.selectOptionsFromConfig()
    },
...
function (o) {
    "use strict";
    function t() {}t.prototype.initTooltipPlugin = function () {
    ...
    t.prototype.initFormValidation = function () {
        o(".needs-validation").on("submit", function (t) {
            return o(this).addClass("was-validated"),
            !1 !== o(this)[0].checkValidity() || (t.preventDefault(), t.stopPropagation(), !1)
        })
    },
    ...
    t.prototype.initMultiDropdown = function () {
        o(".dropdown-menu a.dropdown-toggle").on("click", function (t) {
            return o(this).next().hasClass("show") || o(this).parents(".dropdown-menu").first().find(".show").removeClass("show"),
